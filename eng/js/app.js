 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        document.addEventListener("beforePopupOpen", (e => {
            ...
            if ("#popup_registration" == currentPopup._dataValue || "#popup_auth" == currentPopup._dataValue) menuClose();
        }));
        const payments = document.querySelectorAll(".payment-block__payment-method");
        payments.forEach((payment => {
            payment.addEventListener("click", (e => {
                if (document.querySelector(".payment-block__payment-method._active")) document.querySelector(".payment-block__payment-method._active").classList.remove("_active");
                payment.classList.add("_active");
            }));
        }));
        document.querySelector("#popup_payment .popup__button").addEventListener("click", (() => {
            if (!document.querySelector(".payment-block__payment-method._active")) alert("Сначала укажите метод оплаты!"); else flsModules.popup.close("#popup_payment");
        }));
        isWebp();
        menuInit();
        formFieldsInit({
